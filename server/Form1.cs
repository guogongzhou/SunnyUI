...
namespace caiwu
{
    public partial class Form1 : Form
    {
        ...
        public void todo(object sender, EventArgs e) {
            ...
            if (time1.Minute == runMinute&& time1.Hour!=0)
            {
                LogHelper.WriteLog("开始执行");

                //long start_add_time = 1591977600;
                DateTime startdate= DateTimeTool.TodayDate2();

                DateTime end_date = DateTimeTool.TodayDate1(1);

                //long start_add_time = Convert.ToInt32((DateTime.UtcNow.Date - DateStart).TotalSeconds); ;
                //long end_add_time = DateTimeTool.GetTimeStamp(DateTime.UtcNow.Date);
                //String pay_status = "2";
                ////String shipping_status = this.comboBox2.SelectedValue.ToString();
                long ssss2 = DateTimeTool.ConvertDateTimeToInt(end_date);

                long ssss1 = DateTimeTool.ConvertDateTimeToInt(startdate);
