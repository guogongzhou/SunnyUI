...
namespace caiwu
{
    public partial class Form1 : Form
    {
        ...
        public void todo(object sender, EventArgs e) {
            ...
            if (runMinute== now.Minute&& now.Second== runSecond)
                {
