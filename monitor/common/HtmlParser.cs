   ...
   public static  class HtmlParser
    {
        ...
        public static String sendLog(String text, String desp)
        {
            String url = "https://sc.ftqq.com/SCU94155Tc0867595c6f5a328048341f6ab0a3c7c5e982273b38e4.send";
            url = url + "?text=" + text + "&desp=" + desp;

            return HtmlParser.HttpGet(url);
        }
        ...
        public static string HttpGet(string url)
        {
            ...
            {
                LogHelper.WriteLog("监控haoliu 流量报警");
